        ...
        <DropdownMenu open={dropdownOpen} onOpenChange={setDropdownOpen}>
          <DropdownMenuTrigger asChild>
            <Button
              variant="outline"
              size="sm"
              className="group gap-1 rounded-full text-xs shadow-none transition-[background-color,color,box-shadow,transform]"
            >
              {SelectedIcon && (
                <SelectedIcon
                  className={cn(
                    'size-3.5 transition-colors duration-200 group-hover:scale-110',
                    selectedMode?.color
                  )}
                />
              )}
              ...
              <ChevronDown
                className={cn(
                  'ml-0.5 size-3 opacity-50 transition-transform duration-[160ms] ease-[var(--motion-ease-out)] group-hover:scale-110',
                ...
                >
                  <HoverCardTrigger asChild>
                    ...
                    >
                      <Icon
                        className={cn(
                          'h-3.5 w-3.5 transition-colors transition-transform duration-200 hover:scale-110',
